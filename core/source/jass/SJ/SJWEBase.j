...
globals
    ...
    private constant hashtable BaseHT=InitHashtable()
...
function Revive_Hero_Func takes nothing returns nothing
    ...
    local timerdialog td = LoadTimerDialogHandle(BaseHT, GetHandleId(t), StringHash("timerdialog"))
    local unit whichhero = LoadUnitHandle(BaseHT, GetHandleId(t), StringHash("unit"))
    local real locX = LoadReal(BaseHT, GetHandleId(t), StringHash("locX"))
    local real locY = LoadReal(BaseHT, GetHandleId(t), StringHash("locY"))
    ...
    call FlushChildHashtable(BaseHT, GetHandleId(t))
    call DestroyTimer(t)
    set t = null
    set td = null
    set whichhero = null
...
function Revive_Hero takes unit whichhero, location point, real timeout returns nothing
    ...
    call SaveUnitHandle(BaseHT, GetHandleId(t), StringHash("unit"), whichhero)
    call SaveReal(BaseHT, GetHandleId(t), StringHash("locX"), GetLocationX(point))
    call SaveReal(BaseHT, GetHandleId(t), StringHash("locY"), GetLocationY(point))
    call SaveTimerDialogHandle(BaseHT, GetHandleId(t), StringHash("timerdialog"), td)
