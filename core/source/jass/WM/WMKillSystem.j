...
library WMKillSystem initializer init uses WMBase
...
endglobals
    ...
    private function death takes nothing returns nothing
        ...
        local integer id=GetHandleId(t[kid])-MinHandleId
    ...
    private function RemoveAssists takes nothing returns nothing
        local integer id=GetHandleId(GetExpiredTimer())-MinHandleId
        set b[WMLoadInteger(id,0)][WMLoadInteger(id,1)]=true
    endfunction
    ...
    private function damage takes nothing returns nothing
        ...
        if GetEventDamage()>0 then
            set b[did][kid]=true
            call WMSaveInteger(id,0,did)
            call WMSaveInteger(id,1,kid)
